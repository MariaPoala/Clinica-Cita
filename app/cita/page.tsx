...
export default function CitaPage() {
  return (
    <div>
        <Baner></Baner>
      <h2 className="text-base mt-4 font-semibold leading-6 text-gray-900">Seleccionar fecha de Cita</h2>
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16 mx-6">
        <div className="mt-2 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
          ...
          <button
            type="button"
            className="mt-8 mx-4 w-30 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Add event
          </button>
        </div>
